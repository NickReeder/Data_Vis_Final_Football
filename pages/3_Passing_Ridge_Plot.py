...
st.sidebar.markdown("""
            The plot shown here visualizes the yardage distribution amongst all 32 teams using one of three variables: touchdown passes, screen passes, and play action passes. Here, one can assess the effectiveness of a team's passing game compared to the rest of the league in a given season.
            """)